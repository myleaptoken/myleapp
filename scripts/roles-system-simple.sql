-- =====================================================
-- SISTEMA DE ROLES SIMPLE Y DIRECTO
-- 1. Crear tabla roles
-- 2. Cambiar users.role por users.role_id
-- 3. Facilitadores simples
-- =====================================================
...
-- 3. ELIMINAR COLUMNA ROLE ANTIGUA (si existe)
ALTER TABLE users DROP COLUMN IF EXISTS role;

-- 4. AGREGAR COLUMNA ROLE_ID
ALTER TABLE users 
ADD COLUMN IF NOT EXISTS role_id UUID REFERENCES roles(id);

-- 5. ASIGNAR ROL POR DEFECTO A USUARIOS EXISTENTES
UPDATE users 
...
-- 7. CREAR ALGUNOS USUARIOS FACILITADORES
...
-- 8. LIMPIAR Y RECREAR TABLA FACILITATORS
...
-- 9. CREAR FACILITADORES PARA USUARIOS CON ROL FACILITATOR
...
-- 10. ACTUALIZAR FUNCIÓN GET_UPCOMING_EVENTS
...
-- 11. LIMPIAR EVENTOS Y CREAR NUEVOS
DELETE FROM events;
...
-- 12. FUNCIÓN AUXILIAR PARA OBTENER ROL DE USUARIO
...
-- 13. RECREAR TRIGGER PARA NUEVOS USUARIOS
...
DO $$
BEGIN
    RAISE NOTICE '✅ ¡SISTEMA DE ROLES SIMPLE CREADO!';
    ...
    RAISE NOTICE '🚀 ¡Sistema funcional y organizado!';
END $$;
